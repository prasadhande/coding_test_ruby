...
def solution(a)
  # Create a hash to store the number of occurrences of each element in the array.
  counts = {}
  ...
  unpaired_element = counts.select { |element, count| count.odd? }.keys.first
